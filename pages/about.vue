<template>
  <div class="w-auto md:w-3/4 lg:w-1/2">
    <h1 class="text-5xl md:text-6xl mb-6 leading-tight" style="view-transition-name: title">Hello there.</h1>
    <div class="prose text-lg max-w-full text-gray-600 dark:text-gray-300 leading-relaxed">
      <p>
